...
This chapter covers variable types, tables and plots for describing a single variable, and how to choose between mean and SD or median and IQR. In Chapters 1 and 2 we already covered installing R, finding our way around a project folder, and importing a spreadsheet into R. So in this chapter we go straight to using that data.
