...
This is the exact same call as Week 8's. `t.test()` was already giving us a hypothesis test; Week 8 just hadn't introduced hypothesis testing yet, so we only looked at the confidence interval. Now we bring the rest into view: a t-statistic, degrees of freedom, and a p-value.
