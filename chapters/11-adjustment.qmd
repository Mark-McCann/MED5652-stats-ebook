...
2. Fit a multivariable linear regression using `lm()`, including categorical predictors with a stated reference level
...
6. Write an interpretation of an adjusted association in an appropriate academic style
