...
Two chapters fold the worked example into the chapter's own shape rather than setting it apart as its own section. IES Week 5 builds toward one continuously, ending in your own first script. IES Week 11 opens with an exercise instead, deriving the outcome every model in that chapter needs, and its crude-versus-adjusted and sensitivity-analysis sections do the work a worked example would elsewhere.
