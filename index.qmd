...
Work through the chapters in order. Each one assumes you've already met whatever came before it, and later chapters build on earlier code without re-explaining it. Attempt the exercises yourself before you open the solutions; the point of a collapsed solution is that you look at it after you've tried, not instead of trying. Work along in a script of your own as you go, the same way P2 shows you how to, typing the code rather than copying it. And keep this book open for the rest of the module, not just read once and set aside. It stays the reference you come back to whenever you need a reminder of how something works.
